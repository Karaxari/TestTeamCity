...
public class UserLeaderboardView : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        nameTxt = transform.Find("TextName").GetComponent<Text>();
        pointsTxt = transform.Find("TextScore").GetComponent<Text>();
        //winCountTxt = transform.Find("WinCount").GetComponent<Text>();
    ...
    private void UpdateView()
    {
        ...
        pointsTxt.text = userData.ProgressData.TotalPoints.ToString();

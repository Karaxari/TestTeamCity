...
public class LeaderboardData
{
    ...
    public void SortDescending()
    {
        ...
        List<UserData> sortedUsersList = usersList.OrderByDescending(o => o.ProgressData.TotalPoints).ToList();
    ...
    public void SortAscending()
    {
        List<UserData> usersList = new List<UserData>();
        usersList.AddRange(allUsers);
        List<UserData> sortedUsersList = usersList.OrderBy(o => o.ProgressData.TotalPoints).ToList();
